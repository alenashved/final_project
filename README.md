...
__Анализ и визуализация данных в рамках этапа 3 описаны в ноутбуках из папки "ВИЗУАЛИЗАЦИЯ"__:
     - __2. Расчет плотности ФО по Москве и построение тепловой карты__
     - __3. Расчет плотности ФО по регионам РФ и построение тепловой карты__
     - __4. Создание таблицы рейтингов ФО с учетом метрик плотности__
